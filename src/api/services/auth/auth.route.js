 ...
 * @apiError (Unauthorized 401)  Unauthorized    Incorrect access_token
 */
router.route('/isLogin').get(authorize(), controller.isLogin);
/**
...
router.route('/updateDriverLocation').post(controller.updateDriverLocation)
router.route('/forget').post(controller.forgetPassword);
router.route('/reset').get(controller.reset);
