export default function(firstName, link, email) {
 ...
 <tr style="font-family: 'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"><td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 20px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
 ...
 We’ve received a request that you forgot your password for the Quick Medic app.
...
If that’s you simply click on this link to reset your password.
